...
# image_path   = "./guage_images/5.jpg"
video_path   = "./IMAGES/test.mp4"

yolo = Load_Yolo_model()

for img in os.listdir('./guage_images/'):
    image_path   = "./guage_images/"+img
    image = detect_image(yolo, image_path, "./IMAGES/plate_1_detect.jpg", input_size=YOLO_INPUT_SIZE, show=False, CLASSES=TRAIN_CLASSES, rectangle_colors=(255,0,0))
    cv2.imwrite('./Detected_Images/'+img,image)
    # print(img)
